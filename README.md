react-sticky [![Build Status](https://travis-ci.org/bildeco/react-sticky.svg?branch=master)](https://travis-ci.org/bildeco/react-sticky)
============
...
## Installation
```sh
npm install bildeco-react-sticky
```
